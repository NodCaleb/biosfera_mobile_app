...
#import "StoreTestimonialsVC.h"
#import "TestimonialsData.h"

@interface StoreTestimonialsVC ()

@end

@implementation StoreTestimonialsVC

- (void)viewDidLoad {
    [super viewDidLoad];
    
    self.testimonials = [TestimonialsData storeTestimonials];
}
